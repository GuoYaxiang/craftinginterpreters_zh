...
![The AST for the example statement, with numbers marking the order that the nodes are evaluated.](D:\翻译学习\CraftingInterpreters\15.虚拟机\ast-16511998979731.png)
...
![The series of instructions with bars showing which numbers need to be preserved across which instructions.](D:\翻译学习\CraftingInterpreters\15.虚拟机\bars-16511999147933.png)
...
![Like the previous diagram, but with number bars pushed to the left, forming a stack.](D:\翻译学习\CraftingInterpreters\15.虚拟机\bars-stacked-16511999262195.png)
...
![An array containing the letters in 'crepe' in order starting at element 0.](D:\翻译学习\CraftingInterpreters\15.虚拟机\array.png)
...
![An empty array with stackTop pointing at the first element.](D:\翻译学习\CraftingInterpreters\15.虚拟机\stack-empty.png)
...
![An array with 'c' at element zero.](D:\翻译学习\CraftingInterpreters\15.虚拟机\stack-c.png)

>  . . . `stackTop` always points just past the last item.

`stackTop`一直会超过栈中的最后一个元素。

![An array with 'c', 'r', 'e', 'p', and 'e' in the first five elements.](D:\翻译学习\CraftingInterpreters\15.虚拟机\stack-crepe.png)
...
![A sequence of instructions with the stack for each showing how pushing and then popping values reverses their order.](D:\翻译学习\CraftingInterpreters\15.虚拟机\reverse.png)
...
![The expression being evaluated: -((1.2 + 3.4) / 5.6)](D:\翻译学习\CraftingInterpreters\15.虚拟机\chunk.png)
